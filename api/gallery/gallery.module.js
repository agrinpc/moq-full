...
const gallery_controller_1 = require("./controller/gallery/gallery.controller");
const gallery_schema_1 = require("./schema/gallery.schema");
...
GalleryModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Gallery', schema: gallery_schema_1.GallerySchema }])],
